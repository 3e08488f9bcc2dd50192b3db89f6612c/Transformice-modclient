...
namespace tfmStandalone
{
	public class PinnableWindow : Window
	{
		...
		public bool CanPin
		{
			get
			{
				return (bool)base.GetValue(PinnableWindow.CanPinProperty);
			}
			set
			{
				base.SetValue(PinnableWindow.CanPinProperty, value);
			}
		}
		public bool CanMinimize
		{
			get
			{
				return (bool)base.GetValue(PinnableWindow.CanMinimizeProperty);
			}
			set
			{
				base.SetValue(PinnableWindow.CanMinimizeProperty, value);
			}
		}
		public bool CanMaximize
		{
			get
			{
				return (bool)base.GetValue(PinnableWindow.CanMaximizeProperty);
			}
			set
			{
				base.SetValue(PinnableWindow.CanMaximizeProperty, value);
			}
		}
		public bool CanClose
		{
			get
			{
				return (bool)base.GetValue(PinnableWindow.CanCloseProperty);
			}
			set
			{
				base.SetValue(PinnableWindow.CanCloseProperty, value);
			}
		}
		public override void OnApplyTemplate()
		{
			...
			if (border != null)
			{
				border.MouseUp += delegate(object sender, MouseButtonEventArgs args){base.Topmost = true;};
			}
			Border border2 = base.GetTemplateChild("UnpinButton") as Border;
			if (border2 != null)
			{
				border2.MouseUp += delegate(object sender, MouseButtonEventArgs args) {base.Topmost = false;};
			}
			Border border3 = base.GetTemplateChild("MinimizeButton") as Border;
			if (border3 != null)
			{
				border3.MouseUp += delegate(object sender, MouseButtonEventArgs args) {base.WindowState = WindowState.Minimized;};
			}
			Border border4 = base.GetTemplateChild("MaximizeButton") as Border;
			if (border4 != null)
			{
				border4.MouseUp += delegate(object sender, MouseButtonEventArgs args) {base.WindowState = WindowState.Maximized;};
			}
			Border border5 = base.GetTemplateChild("RestoreButton") as Border;
			if (border5 != null)
			{
				border5.MouseUp += delegate(object sender, MouseButtonEventArgs args) {base.WindowState = WindowState.Normal;};
			}
			Border border6 = base.GetTemplateChild("CloseButton") as Border;
			if (border6 != null)
			{
				border6.MouseUp += delegate(object sender, MouseButtonEventArgs args) {base.Close();};
			}
