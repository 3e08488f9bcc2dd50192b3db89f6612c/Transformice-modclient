...
namespace tfmStandalone
{
	public sealed class MapOverlayViewModel : FolderViewModel
	{
		...
		public MapOverlayViewModel(ClientHook clientHook) : base(null, MapOverlayViewModel.MapsFolder, clientHook)
		{
			...
			this.ToggleCollapsedCommand = new DelegateCommand(delegate() {this.IsCollapsed = !this.IsCollapsed;});
			this.SelectFolderCommand = new DelegateCommand<FolderViewModel>(delegate(FolderViewModel folder) {this.SelectedFolder = folder;});
		}
	}
}
