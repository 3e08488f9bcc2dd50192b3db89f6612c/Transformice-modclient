...
namespace tfmStandalone
{
	public sealed class GameSettings
	{
		...
		private void Load()
		{
			if (File.Exists(GameSettings.SettingsFile))
			{
				try
				{
					...
					if (this.GifLength < 5) this.GifLength = 5;
					if (this.GifLength > 60) this.GifLength = 60;
					string text = (string)((xelement != null) ? xelement.Element("BadNameReason") : null);
					if (!string.IsNullOrWhiteSpace(text)) this.BadNameReason = text;
					...
					if (xelement4 != null) this.UseCustomConnectionLogWindow = (bool)xelement4;
					XElement xelement5 = (xelement != null) ? xelement.Element("UseCustomCasierWindow") : null;
					if (xelement5 != null) this.UseCustomCasierWindow = (bool)xelement5;
					XElement xelement6 = (xelement != null) ? xelement.Element("ChatSettings") : null;
					if (xelement6 != null)
					{
						XElement xelement7 = xelement6.Element("FilterModoChat");
						if (xelement7 != null) this.FilterModoChat = (bool)xelement7;
						XElement xelement8 = xelement6.Element("AlertModoChat");
						if (xelement8 != null) this.AlertModoChat = (bool)xelement8;
						XElement xelement9 = xelement6.Element("LogModoChat");
						if (xelement9 != null) this.LogModoChat = (bool)xelement9;
						XElement xelement10 = xelement6.Element("FilterArbChat");
						if (xelement10 != null) this.FilterArbChat = (bool)xelement10;
						XElement xelement11 = xelement6.Element("AlertArbChat");
						if (xelement11 != null) this.AlertArbChat = (bool)xelement11;
						XElement xelement12 = xelement6.Element("LogArbChat");
						if (xelement12 != null) this.LogArbChat = (bool)xelement12;
						XElement xelement13 = xelement6.Element("FilterServeurMessages");
						if (xelement13 != null) this.FilterServeurMessages = (bool)xelement13;
						XElement xelement14 = xelement6.Element("AlertServeurMessages");
						if (xelement14 != null) this.AlertServeurMessages = (bool)xelement14;
						XElement xelement15 = xelement6.Element("LogServeurMessages");
						if (xelement15 != null) this.LogServeurMessages = (bool)xelement15;
						XElement xelement16 = xelement6.Element("FilterMapCrewChat");
						if (xelement16 != null) this.FilterMapCrewChat = (bool)xelement16;
						XElement xelement17 = xelement6.Element("AlertMapCrewChat");
						if (xelement17 != null) this.AlertMapCrewChat = (bool)xelement17;
						XElement xelement18 = xelement6.Element("LogMapCrewChat");
						if (xelement18 != null) this.LogMapCrewChat = (bool)xelement18;
						XElement xelement19 = xelement6.Element("FilterLuaTeamChat");
						if (xelement19 != null) this.FilterLuaTeamChat = (bool)xelement19;
						XElement xelement20 = xelement6.Element("AlertLuaTeamChat");
						if (xelement20 != null) this.AlertLuaTeamChat = (bool)xelement20;
						XElement xelement21 = xelement6.Element("LogLuaTeamChat");
						if (xelement21 != null) this.LogLuaTeamChat = (bool)xelement21;
						XElement xelement22 = xelement6.Element("FilterFunCorpChat");
						if (xelement22 != null) this.FilterFunCorpChat = (bool)xelement22;
						XElement xelement23 = xelement6.Element("AlertFunCorpChat");
						if (xelement23 != null) this.AlertFunCorpChat = (bool)xelement23;
						XElement xelement24 = xelement6.Element("LogFunCorpChat");
						if (xelement24 != null) this.LogFunCorpChat = (bool)xelement24;
						XElement xelement25 = xelement6.Element("FilterFashionSquadChat");
						if (xelement25 != null) this.FilterFashionSquadChat = (bool)xelement25;
						XElement xelement26 = xelement6.Element("AlertFashionSquadChat");
						if (xelement26 != null) this.AlertFashionSquadChat = (bool)xelement26;
						XElement xelement27 = xelement6.Element("LogFashionSquadChat");
						if (xelement27 != null) this.LogFashionSquadChat = (bool)xelement27;
						XElement xelement28 = xelement6.Element("FilterTribeChat");
						if (xelement28 != null) this.FilterTribeChat = (bool)xelement28;
						XElement xelement29 = xelement6.Element("AlertTribeChat");
						if (xelement29 != null) this.AlertTribeChat = (bool)xelement29;
						XElement xelement30 = xelement6.Element("LogTribeChat");
						if (xelement30 != null) this.LogTribeChat = (bool)xelement30;
						XElement xelement31 = xelement6.Element("FilterWhispers");
						if (xelement31 != null) this.FilterWhispers = (bool)xelement31;
						XElement xelement32 = xelement6.Element("AlertWhispers");
						if (xelement32 != null) this.AlertWhispers = (bool)xelement32;
						XElement xelement33 = xelement6.Element("LogWhispers");
						if (xelement33 != null) this.LogWhispers = (bool)xelement33;
						XElement fontFamily = xelement6.Element("FontFamily");
						if (fontFamily != null) this.FontFamily = Fonts.SystemFontFamilies.FirstOrDefault((FontFamily f) => f.Source == (string)fontFamily);
						XElement xelement34 = xelement6.Element("FontSize");
						if (xelement34 != null) this.FontSize = (int)xelement34;
					}
				}
				catch (Exception)
				{
		...
		// Token: 0x060000E5 RID: 229 RVA: 0x00004EF0 File Offset: 0x000030F0
		public void Save()
		{
