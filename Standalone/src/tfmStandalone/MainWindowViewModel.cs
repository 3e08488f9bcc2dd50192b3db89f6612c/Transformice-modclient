...
namespace tfmStandalone
{
	public class MainWindowViewModel : BindableBase
	{
		...
		public MainWindowViewModel(MessageInterceptor messageInterceptor, GameInfo gameInfo, WindowService windowService, UpdateService updateService)
		{
			...
			this.ShowVpnFarmingWindowCommand = new DelegateCommand(delegate() {this.WindowService.ShowVpnFarmingWindow();});
			this.ShowVpnFarmingRoomWindowCommand = new DelegateCommand(delegate() {this.WindowService.ShowVpnFarmingRoomWindow();});
			this.UpdateCommand = new DelegateCommand(delegate() {this.WindowService.ShowUpdateConfirmationDialog(this.UpdateService);});
