...
{
	public class LogWindow : PinnableWindow, IComponentConnector
	{
		...
		public LogWindowViewModel LogWindowViewModel
		{
			get
			{
				return base.DataContext as LogWindowViewModel;
			}
			set
			{
		...
		private ScrollViewer ScrollViewer
		{
			get
			{
				...
				{
					this._scrollViewer = (this.FlowDocumentScrollViewer.Template.FindName("PART_ContentHost", this.FlowDocumentScrollViewer) as ScrollViewer);
				}
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocator = new Uri("/Transformice;component/views/logwindow.xaml", UriKind.Relative);
