...
namespace Transformice.tfmStandalone
{
	public sealed class ImageButton : Button
	{
		...
		public ImageSource ImageHover
		{
			get
			{
				return (ImageSource)base.GetValue(ImageButton.ImageHoverProperty);
			}
			set
			{
				base.SetValue(ImageButton.ImageHoverProperty, value);
			}
		}
		...
		public ImageSource ImagePressed
		{
			get
			{
				return (ImageSource)base.GetValue(ImageButton.ImagePressedProperty);
			}
			set
			{
				base.SetValue(ImageButton.ImagePressedProperty, value);
			}
		}
