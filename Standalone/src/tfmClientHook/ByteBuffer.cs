...
namespace tfmClientHook
{
	public sealed class ByteBuffer
	{
		...
		public ByteBuffer() => this._byteList = new List<byte>();
		public int Count { get { return this._byteList.Count; } }
		public byte this[int index] { get { return this._byteList[index]; } }
		public void WriteByte(byte b) // Writes a byte
		{
			this._byteList.Add(b);
		}
		public void WriteBytes(byte[] byteList) // Writes array of byte
		{
		...
		public byte[] GetBytes() { return this._byteList.ToArray(); }
	}
}
